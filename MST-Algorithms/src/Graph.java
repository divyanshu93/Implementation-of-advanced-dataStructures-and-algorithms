...
class Graph implements Iterable<Vertex> {
	...
	public List<Edge> edges;// array of edges
	public int numNodes; // number of verices in the graph
	public int noOfEdges;// number of edges in the graph
	...
	Edge graphEdge(Vertex u, Vertex v, int w) {
